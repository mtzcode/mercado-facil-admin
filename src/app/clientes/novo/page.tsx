  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userData = {
        ...
        telefone: formData.whatsapp, // Salvando como telefone na estrutura do app cliente
        whatsapp: formData.whatsapp, // Mantendo para compatibilidade
        ativo: formData.ativo,
        cadastroCompleto: formData.cadastroCompleto,
        endereco: formData.endereco,
        enderecos: [formData.endereco], // Salvando também na lista como no Flutter
      ...
      // Salvando na coleção 'users' onde estão os dados reais dos usuários
